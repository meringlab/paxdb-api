...
function defaultDataset(datasets) {
    ...
    let candidate = datasets.find(e => e.integrated && e.organ === 'WHOLE_ORGANISM');
    if (candidate) {
        return candidate;
    }
    candidate = datasets.find(e => e.integrated);
    if (candidate) {
        return candidate;
    }
    return datasets[0];
...
if (typeof module !== 'undefined' && module.exports) { // Node.js
    ...
    root.defaultDataset = defaultDataset; // eslint-disable-line no-undef
}
